...
{% else %}
  ...
  However, it's hard to interacts directly outside of domain logic from the Gleam code (like interacts heavily with the "real world," like update node tree or handling physics for exmaple)...
{% endif %}
