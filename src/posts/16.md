...
{% else %}
  ...
  > [**Dong:** It is not anything related to legal issues. I just cannot keep it anymore.](https://twitter.com/dongatory/status/432228383095668737)
...
{% else %}
  ...
  On February 8th, two days after Kotaku's accusatory article was published, another author of the news site wrote an article ["The Flappy Bird Fiasco"](https://kotaku.com/the-flappy-bird-fiasco-1519938266) apologizing to Nguyen Ha Dong:
...
<figure class="w-full">
  <img
    ...
    alt="Nguyễn Hà Đông"
  />
  <figcaption class="text-center">{% if lang == 'vi' %}Hình ảnh của Nguyễn Hà Đông chụp trên trang tin RollingStone{% else %}Picture of Nguyen Ha Dong from a RollingStone's article{% endif %}</figcaption>
</figure>
...
{% if lang == 'vi' %}
  ...
  Rất nhiều người (bao gồm cả bản thân mình hồi trước) cho rằng Flappy Bird chỉ là một trò chơi chìm nghỉm, may mắn được Youtuber nổi tiếng nhất thời điểm bấy giờ - Pewdiepie - chơi và giới thiệu thì độ nổi tiếng của chú chim vàng mới được sải cánh tung bay. Video ["FLAPPY BIRD - DONT PLAY THIS GAME!"](https://youtu.be/lQz6xhlOt18) được đăng vào ngày 28 tháng 1 trên kênh Youtube PewDiePie được rất nhiều cư dân mạng cho là nguyên nhân trục tiếp khiến Flappy Bird trở nên nổi tiếng.
{% else %}
...
{% if lang == 'vi' %}
  ...
  Mọi chuyện càng trở nên rõ ràng hơn khi bạn thật sự xem video mà Felix chơi Flappy Bird, [bắt đầu từ phút 4:02 trong video](https://youtu.be/lQz6xhlOt18?t=242).
