...
{% if lang == 'vi' %}
  ...
  - Và vẫn có thể hiển thị các thông tin: Nó tối hơn phương pháp _Gắn liền_ trong tabs workspace vì nó còn hiển thị thêm các thông tin khác như workspaces và đồng hồ...
